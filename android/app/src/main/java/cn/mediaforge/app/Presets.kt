...
object Presets {
    ...
    val BUILTIN: List<Preset> = listOf(
        ...
        Preset("GIF 动图", Formats.VIDEO, "gif",
            ...
            "调色板优化，画质更好", true),
        Preset("WebP 动图", Formats.VIDEO, "webp",
            v("webp", "libwebp", "", "fps" to "12", "width" to 480, "quality" to 75,
                "compression_level" to 4, "gif_loop" to 0),
            "体积比 GIF 更小，兼容现代浏览器", true),
        Preset("APNG 动图", Formats.VIDEO, "apng",
            v("apng", "apng", "", "fps" to "12", "width" to 480, "gif_loop" to 0),
            "无损动图，支持透明", true),
        Preset("Live Photo 动态照片", Formats.VIDEO, "mp.jpg",
            v("mp.jpg", "libx264", "aac", "crf" to 23.0, "width" to 1080,
                "audio_bitrate" to "128k"),
